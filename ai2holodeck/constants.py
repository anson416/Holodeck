...
OBJATHOR_ASSETS_DIR = os.path.join(OBJATHOR_ASSETS_BASE_DIR, ASSETS_VERSION, "assets")
OBJATHOR_FEATURES_DIR = os.path.join(
    OBJATHOR_ASSETS_BASE_DIR, ASSETS_VERSION, "features"
)
OBJATHOR_ANNOTATIONS_PATH = os.path.join(
    OBJATHOR_ASSETS_BASE_DIR, ASSETS_VERSION, "annotations.json.gz"
)
